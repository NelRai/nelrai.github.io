...
<template>
    ...
    <div class="card w-full p-4 flex flex-col gap-2 items-start text-neutral-700 bg-neutral-50 border border-solid border-neutral-200 rounded-lg hover:border-neutral-100 hover:cursor-pointer hover:text-neutral-500 active:border-red-400  group/card  relative transition-all ">
        ...
        <div class="result-close  opacity-0 group-hover/card:opacity-100 group/icon absolute -bottom-1 -right-1 transition-all ">
            <button
                class="sidebar-close-btn  w-10 h-10  items-center justify-center rounded-full bg-neutral-50 border border-neutral-200 hover:border-neutral-100 transition-all  flex z-40 ">
