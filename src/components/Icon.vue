...
<template>
  <button
    class="sidebar-close-btn  w-10 h-10 items-center justify-center rounded-full  bg-neutral-50 border border-neutral-200 flex z-40 hover:border-neutral-200 hover:bg-neutral-100 active:border-red-400 group/icon transition-0-3s">
    ...
    <bars2  v-if="bars2_icon" class="svgIcon " />
    <bars3   v-if="bars3_icon" class="svgIcon " />
