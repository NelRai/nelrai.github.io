...
<!-- 
        ...
        <div class="card-tag px-2 py-[6px] bg-neutral-50  border border-solid border-neutral-200 rounded-lg text-xs font-normal z-20 hover:border-neutral-100 hover:cursor-pointer hover:text-neutral-500 group/icon ">
